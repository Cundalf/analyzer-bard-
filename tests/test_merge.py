...
def test_inherit_language_country_instrumentation():
    album = make_album_ficha({"language": "es", "country": "AR", "instrumentation": ["guitarra"]})
...
def test_inherit_album_wins_over_artist_scalar():
    ...
    ficha = inherit_track_ficha(None, {"navidrome_id": "t1", "title": "T"}, album, artist)
    assert ficha.facets["language"] == "es"
...
def test_inherit_genres_from_subgenres():
    ...
    ficha = inherit_track_ficha(None, {"navidrome_id": "t1", "title": "T"}, album, None)
